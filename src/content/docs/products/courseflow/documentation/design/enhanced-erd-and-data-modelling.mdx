...
![Courseflow High Level Entity Relationship](/courseflow/courseflow-high-level-entity-relationship.png)

The next diagram is the fully fleshed out ERD with the different fields and relationships to other
entities.

![Courseflow Enhanced ERD](/courseflow/courseflow-enhanced-erd.png)
